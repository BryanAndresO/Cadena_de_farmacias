    ...
    <div className="min-h-screen flex bg-slate-50">
      ...
      <aside className="w-64 fixed h-full z-40 transition-transform duration-200 sidebar rounded-tr-2xl rounded-br-2xl overflow-hidden">
        ...
        <nav className="p-4 space-y-3">
          ...
          <SidebarLink to="/inventory-history" icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M13 3c-4.97 0-9 4.03-9 9H1l3.89 3.89.07.14L9 12H6c0-3.87 3.13-7 7-7s7 3.13 7 7-3.13 7-7 7c-1.93 0-3.68-.79-4.94-2.06l-1.42 1.42C8.27 19.99 10.51 21 13 21c4.97 0 9-4.03 9-9s-4.03-9-9-9zm-1 5v5l4.28 2.54.72-1.21-3.5-2.08V8H12z" /></svg>} label="Historial" requireAdmin={true} />
          ...
          <SidebarLink to="/users" icon={<svg xmlns="http://www.w3.org/2000/svg" className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" /></svg>} label="Usuarios" requireAdmin={true} />
        </nav>
      </aside>
